...
public class Pokemon
{
    ...
    public IntValue saveLevel;
    public IntValue saveXP;
    ...
    public void Init()
    {
        ...
        if (saveXP != null && saveXP.RuntimeValue != 0){
            XP = saveXP.RuntimeValue;
        }
        if (saveLevel != null && saveLevel.RuntimeValue != 0){
            level = saveLevel.RuntimeValue;
        }
    ...
    public bool LevelUp()
    {
        if (XP > Base.GetExpForLevel(level + 1))
        {
            ++level;
            if (saveLevel != null){
                saveLevel.RuntimeValue = Level;
            }
           // saveXP.RuntimeValue=XP; 
            return true;
        }
        return false;
    }
    public void saveNewXP(){
        if(saveXP != null){
            saveXP.RuntimeValue = XP;
        }
    }
